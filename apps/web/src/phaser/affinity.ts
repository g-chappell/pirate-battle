...
export const AFFINITY_COLORS: Readonly<Record<Affinity, number>> = Object.freeze({
  kraken: 0x0a7e7e,
  ironclad: 0x4a4a4a,
  phantom: 0x9b59b6,
  bloodborne: 0xb22222,
...
export const AFFINITY_TEXTURE_KEYS: Readonly<Record<Affinity, string>> = Object.freeze({
  kraken: "crew-kraken",
...
export function computeHpBarWidth(hp: number, maxHp: number, totalWidth: number): number {
